    ...
    <MemberLayout>
      <div className="bg-card rounded-xl shadow-sm border border-border overflow-hidden">
        <div className="p-6 border-b border-border bg-muted/20">
          <h2 className="text-2xl font-bold font-heading text-foreground">Recharge</h2>
          <p className="text-sm text-muted-foreground mt-1">Manage your recharge details.</p>
        </div>
        <div className="p-6">
        ...
        <div className="max-w-md space-y-4">
          ...
          <div>
            <label className="text-sm font-medium text-muted-foreground block mb-1">Amount to Recharge</label>
