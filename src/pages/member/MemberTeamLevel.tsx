...
const MemberTeamLevel = () => {
  return (
    <MemberLayout>
      <div className="bg-card rounded-xl shadow-sm border border-border overflow-hidden">
        <div className="p-6 border-b border-border bg-muted/20">
          <h2 className="text-2xl font-bold font-heading text-foreground">Level Team</h2>
          <p className="text-sm text-muted-foreground mt-1">Manage your level team details.</p>
        </div>
        <div className="p-6">
...
export default MemberTeamLevel;
