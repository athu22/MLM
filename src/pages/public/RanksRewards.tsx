    ...
    <div className="min-h-screen bg-[#0F111A] text-white flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 lg:px-8 py-16">
        ...
        <div className="max-w-4xl mx-auto bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-md shadow-2xl">
          <h1 className="text-4xl font-bold font-heading mb-4 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">Ranks & Rewards</h1>
          <p className="text-lg text-white/70 mb-8 border-b border-white/10 pb-8">Climb the ladder and achieve exciting rewards.</p>
          
          <div className="space-y-6 text-white/80 leading-relaxed">
            <p>Welcome to the Ranks & Rewards page. This section will contain detailed information regarding our operations, guidelines, and benefits tailored to help you succeed in the Jample Life network.</p>
            ...
            <div className="mt-8 p-6 bg-primary/10 border border-primary/20 rounded-xl relative overflow-hidden">
              ...
              <p className="text-white/80 relative z-10">If you have specific questions about ranks & rewards, please feel free to reach out to our network support team at any time.</p>
            </div>
          </div>
        </div>
      </main>
